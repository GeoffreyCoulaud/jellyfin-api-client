...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "HeadVideoStreamByContainerStreamOptions"] = UNSET,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "head",
        "url": "/Videos/{itemId}/stream.{container}".format(
            itemId=item_id,
            container=container,
        ),
        "params": params,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, HeadVideoStreamByContainerStreamOptions]):
