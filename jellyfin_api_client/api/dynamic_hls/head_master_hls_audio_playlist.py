...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "HeadMasterHlsAudioPlaylistStreamOptions"] = UNSET,
    ...
    return {
        "method": "head",
        "url": "/Audio/{itemId}/master.m3u8".format(
            itemId=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, HeadMasterHlsAudioPlaylistStreamOptions]):
