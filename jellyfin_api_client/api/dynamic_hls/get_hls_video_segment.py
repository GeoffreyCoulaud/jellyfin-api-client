...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "GetHlsVideoSegmentStreamOptions"] = UNSET,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "get",
        "url": "/Videos/{itemId}/hls1/{playlistId}/{segmentId}.{container}".format(
            itemId=item_id,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, GetHlsVideoSegmentStreamOptions]):
