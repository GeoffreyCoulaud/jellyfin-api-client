...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "GetVariantHlsVideoPlaylistStreamOptions"] = UNSET,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "get",
        "url": "/Videos/{itemId}/main.m3u8".format(
            itemId=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, GetVariantHlsVideoPlaylistStreamOptions]):
