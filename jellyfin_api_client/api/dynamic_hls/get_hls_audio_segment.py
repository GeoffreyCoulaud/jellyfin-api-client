...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "GetHlsAudioSegmentStreamOptions"] = UNSET,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "get",
        "url": "/Audio/{itemId}/hls1/{playlistId}/{segmentId}.{container}".format(
            itemId=item_id,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, GetHlsAudioSegmentStreamOptions]):
