...
def _get_kwargs(
    ...
    *,
    ...
    stream_options: Union[Unset, None, "HeadMasterHlsVideoPlaylistStreamOptions"] = UNSET,
    enable_adaptive_bitrate_streaming: Union[Unset, None, bool] = True,
) -> Dict[str, Any]:
    pass
    ...
    return {
        "method": "head",
        "url": "/Videos/{itemId}/master.m3u8".format(
            itemId=item_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        stream_options (Union[Unset, None, HeadMasterHlsVideoPlaylistStreamOptions]):
        enable_adaptive_bitrate_streaming (Union[Unset, None, bool]):  Default: True.
