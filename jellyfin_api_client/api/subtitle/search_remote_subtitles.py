...
) -> Optional[Union[Any, List["RemoteSubtitleInfo"], ProblemDetails]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["RemoteSubtitleInfo"], ProblemDetails]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, List['RemoteSubtitleInfo'], ProblemDetails]
    """
