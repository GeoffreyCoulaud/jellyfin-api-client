...
class SeriesTimerInfoDtoQueryResult:
    ...
    items: Union[List["SeriesTimerInfoDto"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(
            data: object,
        ) -> Union[List["SeriesTimerInfoDto"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = SeriesTimerInfoDto.from_dict(
                ...
                pass
            return cast(Union[List["SeriesTimerInfoDto"], None, Unset], data)
