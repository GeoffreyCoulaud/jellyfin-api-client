...
class LibraryOptions:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        extract_trickplay_images_during_library_scan = self.extract_trickplay_images_during_library_scan
        ...
        if enable_trickplay_image_extraction is not UNSET:
            field_dict["EnableTrickplayImageExtraction"] = enable_trickplay_image_extraction
        if extract_trickplay_images_during_library_scan is not UNSET:
            field_dict["ExtractTrickplayImagesDuringLibraryScan"] = extract_trickplay_images_during_library_scan
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        enable_trickplay_image_extraction = d.pop("EnableTrickplayImageExtraction", UNSET)

        extract_trickplay_images_during_library_scan = d.pop("ExtractTrickplayImagesDuringLibraryScan", UNSET)
        ...
        def _parse_local_metadata_reader_order(data: object) -> Union[List[str], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_subtitle_download_languages(data: object) -> Union[List[str], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
