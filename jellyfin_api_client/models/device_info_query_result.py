...
class DeviceInfoQueryResult:
    """
    Attributes:
        items (Union[Unset, None, List['DeviceInfo']]): Gets or sets the items.
    ...
    items: Union[Unset, None, List["DeviceInfo"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items or []:
            items_item = DeviceInfo.from_dict(items_item_data)
