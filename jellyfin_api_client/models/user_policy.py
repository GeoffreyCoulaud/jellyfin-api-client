...
class UserPolicy:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_access_schedules(data: object) -> Union[List["AccessSchedule"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_block_unrated_items(data: object) -> Union[List[UnratedItem], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_content_deletion_from_folders(data: object) -> Union[List[str], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        enable_content_deletion_from_folders = _parse_enable_content_deletion_from_folders(
