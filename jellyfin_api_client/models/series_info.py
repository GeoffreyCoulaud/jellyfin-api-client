...
if TYPE_CHECKING:
    from ..models.series_info_provider_ids import SeriesInfoProviderIds
...
class SeriesInfo:
    ...
    Attributes:
        ...
        provider_ids (Union[Unset, None, SeriesInfoProviderIds]): Gets or sets the provider ids.
    ...
    provider_ids: Union[Unset, None, "SeriesInfoProviderIds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        provider_ids: Union[Unset, None, SeriesInfoProviderIds]
        if _provider_ids is None:
            provider_ids = None
        elif isinstance(_provider_ids, Unset):
            provider_ids = UNSET
        else:
            provider_ids = SeriesInfoProviderIds.from_dict(_provider_ids)
