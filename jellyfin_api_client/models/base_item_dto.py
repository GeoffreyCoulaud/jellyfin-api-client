...
class BaseItemDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_date_last_media_added(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_preferred_metadata_country_code(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_external_urls(data: object) -> Union[List["ExternalUrl"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_media_sources(data: object) -> Union[List["MediaSourceInfo"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_media_source_display(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_remote_trailers(data: object) -> Union[List["MediaUrl"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_genre_items(data: object) -> Union[List["NameGuidPair"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_primary_image_aspect_ratio(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_artist_items(data: object) -> Union[List["NameGuidPair"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_album_artists(data: object) -> Union[List["NameGuidPair"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_trickplay(data: object) -> Union["BaseItemDtoTrickplayType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_locked_fields(data: object) -> Union[List[MetadataField], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        normalization_gain = _parse_normalization_gain(d.pop("NormalizationGain", UNSET))
