...
if TYPE_CHECKING:
    from ..models.person_lookup_info_provider_ids import PersonLookupInfoProviderIds
...
class PersonLookupInfo:
    ...
    Attributes:
        ...
        provider_ids (Union[Unset, None, PersonLookupInfoProviderIds]): Gets or sets the provider ids.
    ...
    provider_ids: Union[Unset, None, "PersonLookupInfoProviderIds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        provider_ids: Union[Unset, None, PersonLookupInfoProviderIds]
        if _provider_ids is None:
            provider_ids = None
        elif isinstance(_provider_ids, Unset):
            provider_ids = UNSET
        else:
            provider_ids = PersonLookupInfoProviderIds.from_dict(_provider_ids)
