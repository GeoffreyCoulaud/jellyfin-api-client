...
class CodecProfile:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.apply_conditions, Unset):
            ...
            for apply_conditions_type_0_item_data in self.apply_conditions:
                apply_conditions_type_0_item = (
                    apply_conditions_type_0_item_data.to_dict()
                )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_conditions(
            data: object,
        ) -> Union[List["ProfileCondition"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for conditions_type_0_item_data in _conditions_type_0:
                    conditions_type_0_item = ProfileCondition.from_dict(
        ...
        def _parse_apply_conditions(
            ...
            try:
                ...
                for apply_conditions_type_0_item_data in _apply_conditions_type_0:
                    apply_conditions_type_0_item = ProfileCondition.from_dict(
                        apply_conditions_type_0_item_data
                    )
