...
class ScheduledTasksInfoMessage:
    ...
    Attributes:
        data (Union[List['TaskInfo'], None, Unset]): Gets or sets the data.
    ...
    data: Union[List["TaskInfo"], None, Unset] = UNSET
    message_id: Union[Unset, str] = UNSET
    message_type: Union[Unset, SessionMessageType] = SessionMessageType.SCHEDULEDTASKSINFO
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[List["TaskInfo"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[List["TaskInfo"], None, Unset], data)
