...
class UserDataChangeInfo:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_data_list(data: object) -> Union[List["UserItemDataDto"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for user_data_list_type_0_item_data in _user_data_list_type_0:
                    user_data_list_type_0_item = UserItemDataDto.from_dict(user_data_list_type_0_item_data)
