...
class LiveTvOptions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_tuner_hosts(data: object) -> Union[List["TunerHostInfo"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_listing_providers(data: object) -> Union[List["ListingsProviderInfo"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_media_locations_created(data: object) -> Union[List[str], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_recording_post_processor_arguments(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
