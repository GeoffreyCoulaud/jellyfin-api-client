...
class AuthenticationInfoQueryResult:
    ...
    items: Union[List["AuthenticationInfo"], None, Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_items(
            data: object,
        ) -> Union[List["AuthenticationInfo"], None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = AuthenticationInfo.from_dict(
                ...
                pass
            return cast(Union[List["AuthenticationInfo"], None, Unset], data)
