...
if TYPE_CHECKING:
    from ..models.book_info_provider_ids import BookInfoProviderIds
...
class BookInfo:
    ...
    Attributes:
        ...
        provider_ids (Union[Unset, None, BookInfoProviderIds]): Gets or sets the provider ids.
        ...
        series_name (Union[Unset, None, str]):
    """
    ...
    provider_ids: Union[Unset, None, "BookInfoProviderIds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        provider_ids: Union[Unset, None, BookInfoProviderIds]
        if _provider_ids is None:
            provider_ids = None
        elif isinstance(_provider_ids, Unset):
            provider_ids = UNSET
        else:
            provider_ids = BookInfoProviderIds.from_dict(_provider_ids)
