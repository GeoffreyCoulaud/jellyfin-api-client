...
class SessionInfo:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.playable_media_types, Unset):
            ...
            for playable_media_types_type_0_item_data in self.playable_media_types:
                playable_media_types_type_0_item = playable_media_types_type_0_item_data.value
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_additional_users(data: object) -> Union[List["SessionUserInfo"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_playable_media_types(data: object) -> Union[List[MediaType], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for playable_media_types_type_0_item_data in _playable_media_types_type_0:
                    playable_media_types_type_0_item = MediaType(playable_media_types_type_0_item_data)
        ...
        def _parse_last_paused_date(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_now_playing_queue_full_items(data: object) -> Union[List["BaseItemDto"], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_supported_commands(data: object) -> Union[List[GeneralCommandType], None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
