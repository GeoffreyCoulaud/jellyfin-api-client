...
if TYPE_CHECKING:
    from ..models.music_video_info_provider_ids import MusicVideoInfoProviderIds
...
class MusicVideoInfo:
    ...
    Attributes:
        ...
        provider_ids (Union[Unset, None, MusicVideoInfoProviderIds]): Gets or sets the provider ids.
    ...
    provider_ids: Union[Unset, None, "MusicVideoInfoProviderIds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        provider_ids: Union[Unset, None, MusicVideoInfoProviderIds]
        if _provider_ids is None:
            provider_ids = None
        elif isinstance(_provider_ids, Unset):
            provider_ids = UNSET
        else:
            provider_ids = MusicVideoInfoProviderIds.from_dict(_provider_ids)
