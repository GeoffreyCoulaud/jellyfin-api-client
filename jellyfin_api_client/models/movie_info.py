...
if TYPE_CHECKING:
    from ..models.movie_info_provider_ids import MovieInfoProviderIds
...
class MovieInfo:
    ...
    Attributes:
        ...
        provider_ids (Union[Unset, None, MovieInfoProviderIds]): Gets or sets the provider ids.
    ...
    provider_ids: Union[Unset, None, "MovieInfoProviderIds"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        provider_ids: Union[Unset, None, MovieInfoProviderIds]
        if _provider_ids is None:
            provider_ids = None
        elif isinstance(_provider_ids, Unset):
            provider_ids = UNSET
        else:
            provider_ids = MovieInfoProviderIds.from_dict(_provider_ids)
