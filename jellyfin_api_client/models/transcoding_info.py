...
from ..models.transcoding_info_hardware_acceleration_type import TranscodingInfoHardwareAccelerationType
from ..types import UNSET, Unset
...
class TranscodingInfo:
    ...
    hardware_acceleration_type: Union[Unset, TranscodingInfoHardwareAccelerationType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_hardware_acceleration_type, Unset):
            ...
            hardware_acceleration_type = TranscodingInfoHardwareAccelerationType(_hardware_acceleration_type)
