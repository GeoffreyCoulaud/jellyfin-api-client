...
class SyncPlayGroupUpdateCommandMessage:
    ...
    message_type: Union[Unset, SessionMessageType] = SessionMessageType.SYNCPLAYGROUPUPDATE
        ...
        def _parse_data(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_group_update_type_0 = GroupInfoDtoGroupUpdate.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_group_update_type_1 = GroupStateUpdateGroupUpdate.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_group_update_type_2 = StringGroupUpdate.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                componentsschemas_group_update_type_3 = PlayQueueUpdateGroupUpdate.from_dict(data)
